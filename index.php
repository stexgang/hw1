<html>
    ...
    <body>
        <nav id="barra"> 
            ...
            <a id="shoppingbag" href="login.php"><img src="Icons8-Ios7-Ecommerce-Shopping-Bag.512.png" alt="shoppingbag" class="shoppingbag"></a>
        </nav>
      <div id="flexbox">
        ...
        <div id="flex2">
            ...
            <div id="box2"><a href="login.php">Acquista</a></div>
        </div>
